<div class="header ">
    ...
    <div class="">
        ...
        <a href="#" class="search-link d-none d-lg-inline-block d-xl-inline-block" data-toggle="search">
    ...
    <div class="d-flex align-items-center">
        ...
        <!-- END User Info-->
        <a href="#" class="header-icon btn-icon-link m-l-10 sm-no-margin d-inline-block" data-toggle="quickview"
